...
def take_stat (dict_of_temp):
    ...
    return(min_temperature, min_temp_data, max_temperature, max_temp_data, average_temperature)


dict_temp = make_dict('weather.txt')
min_temperature, min_temp_data, max_temperature, max_temp_data, average_temperature = take_stat(dict_temp)
